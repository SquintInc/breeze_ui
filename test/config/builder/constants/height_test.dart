    ...
    test('is generated with varying unit types', () {
      ...
      expect(
        h_frac_1_2 == h_frac_2_4 &&
            ...
            h_frac_3_6 == h_frac_6_12,
        isTrue,
      );
      expect(h_full.value, equals(PercentUnit(100)));
      expect(h_screen.value, equals(ViewportUnit(100)));
      expect(h_svw.value, equals(SmallViewportUnit(100)));
      expect(h_lvw.value, equals(LargeViewportUnit(100)));
      expect(h_dvw.value, equals(DynamicViewportUnit(100)));
    });
  });
}
