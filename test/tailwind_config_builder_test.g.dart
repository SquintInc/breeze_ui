...
typedef _BreakpointGetter = Map<String, dynamic> Function(Map<String, dynamic>);

final Map<String, dynamic> _defaultConfigFull = {
  'content': ['auto'],
  'presets': [],
  'darkMode': 'media', // or 'class'
  'theme': {
    'accentColor': (
            {required _ThemeValueGetter theme,
            _BreakpointGetter? breakpoints}) =>
        ({
          ...theme('colors') as Map<String, dynamic>,
          'auto': 'auto',
        }),
    'animation': {
      'none': 'none',
    ...
    'borderSpacing': (
            ...
            _BreakpointGetter? breakpoints}) =>
        ({
          ...theme('spacing') as Map<String, dynamic>,
        }),
    'borderWidth': {
      'DEFAULT': '1px',
      '0': '0px',
    ...
    'ringOpacity': (
        ...
        ({
          'DEFAULT': '0.5',
          ...theme('opacity') as Map<String, dynamic>,
        }),
    'ringWidth': {
      'DEFAULT': '3px',
      '0': '0px',
